...
4. Paste an example suite or a suite generated by ChatGPT.
5. Click `Validate`.
6. Use `Copy Self-Contained Runner`, paste it into the ChatGPT page console once per page load, then use the overlay `Run` button.
7. Use the downloaded `orion-casework-result-*.json` file as the primary result artifact.
