# Casework Review: done-vs-move-on-small-v1

- **Run ID**: `20260612-194203-done-vs-move-on-small-v1`
- **Imported At**: 2026-06-12T23:42:21.678Z
- **Raw Result JSON**: `study/raw/2026-06-12/done-vs-move-on-small-v1__20260612-194203-done-vs-move-on-small-v1.json`
- **Case Count**: 3

## Reflection Checklist
- [x] Mermaid-first review generated
- [x] Most important pass identified: Done completes clear_trash but does not advance (PASS_CANDIDATE)
- [x] Most important failure identified: Move_on after done advances exactly one chunk (FAIL_LOST_ROUTE)
...
```mermaid
flowchart TD
  A["Run 20260612-194203-done-vs-move-on-small-v1"] --> B["Pass cases: 2"]
  A --> C["Fail cases: 1"]
  A --> D["Tool failures: 0"]
...
## Key Findings
- Most important pass: Done completes clear_trash but does not advance (PASS_CANDIDATE).
- Most important failure: Move_on after done advances exactly one chunk (FAIL_LOST_ROUTE).
...
## Artifact Paths
- Raw evidence: `study/raw/2026-06-12/done-vs-move-on-small-v1__20260612-194203-done-vs-move-on-small-v1.json`
- Review: `study/reviews/2026-06-12/done-vs-move-on-small-v1__20260612-194203-done-vs-move-on-small-v1.md`
