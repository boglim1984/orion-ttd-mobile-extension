# Casework Review: route_law_active_carrier_position_generalization_v1

- **Run ID**: `20260613-191805-route_law_active_carrier_position_generalization_v1`
- **Imported At**: 2026-06-13T23:23:59.505Z
- **Raw Result JSON**: `study/raw/2026-06-13/route_law_active_carrier_position_generalization_v1__20260613-191805-route_law_active_carrier_position_generalization_v1.json`
- **Case Count**: 15

## Reflection Checklist
- [x] Mermaid-first review generated
- [x] Most important pass identified: Clear-trash active id-only baseline (PASS_CANDIDATE)
- [x] Most important failure identified: Next-only no-active negative control (HOLD_NEEDS_REVIEW)
...
```mermaid
flowchart TD
  A["Run 20260613-191805-route_law_active_carrier_position_generalization_v1"] --> B["Pass cases: 14"]
  A --> C["Fail cases: 0"]
  A --> D["Tool failures: 0"]
...
## Key Findings
- Most important pass: Clear-trash active id-only baseline (PASS_CANDIDATE).
- Most important failure: Next-only no-active negative control (HOLD_NEEDS_REVIEW).
...
## Artifact Paths
- Raw evidence: `study/raw/2026-06-13/route_law_active_carrier_position_generalization_v1__20260613-191805-route_law_active_carrier_position_generalization_v1.json`
- Review: `study/reviews/2026-06-13/route_law_active_carrier_position_generalization_v1__20260613-191805-route_law_active_carrier_position_generalization_v1.md`
