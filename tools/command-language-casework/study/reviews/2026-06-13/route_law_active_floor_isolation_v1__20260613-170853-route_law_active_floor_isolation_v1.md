# Casework Review: route_law_active_floor_isolation_v1

- **Run ID**: `20260613-170853-route_law_active_floor_isolation_v1`
- **Imported At**: 2026-06-13T21:13:27.719Z
- **Raw Result JSON**: `study/raw/2026-06-13/route_law_active_floor_isolation_v1__20260613-170853-route_law_active_floor_isolation_v1.json`
- **Case Count**: 7

## Reflection Checklist
- [x] Mermaid-first review generated
- [x] Most important pass identified: Active ID only cold candidate (PASS_CANDIDATE)
- [x] Most important failure identified: Near-empty first negative before route exposure (HOLD_NEEDS_REVIEW)
...
```mermaid
flowchart TD
  A["Run 20260613-170853-route_law_active_floor_isolation_v1"] --> B["Pass cases: 3"]
  A --> C["Fail cases: 0"]
  A --> D["Tool failures: 0"]
...
## Key Findings
- Most important pass: Active ID only cold candidate (PASS_CANDIDATE).
- Most important failure: Near-empty first negative before route exposure (HOLD_NEEDS_REVIEW).
...
## Artifact Paths
- Raw evidence: `study/raw/2026-06-13/route_law_active_floor_isolation_v1__20260613-170853-route_law_active_floor_isolation_v1.json`
- Review: `study/reviews/2026-06-13/route_law_active_floor_isolation_v1__20260613-170853-route_law_active_floor_isolation_v1.md`
