# Casework Review: route_law_cold_first_active_label_route_sequence_wrong_next_v1

- **Run ID**: `20260613-181227-route_law_cold_first_active_label_route_sequence_wrong_next_v1`
- **Imported At**: 2026-06-13T22:38:52.332Z
- **Raw Result JSON**: `study/raw/2026-06-13/route_law_cold_first_active_label_route_sequence_wrong_next_v1__20260613-181227-route_law_cold_first_active_label_route_sequence_wrong_next_v1.json`
- **Case Count**: 8

## Reflection Checklist
- [x] Mermaid-first review generated
- [x] Most important pass identified: Cold label plus route sequence defeats wrong next id (PASS_CANDIDATE)
- [x] Most important failure identified: Negative control wrong next only without route (HOLD_NEEDS_REVIEW)
...
```mermaid
flowchart TD
  A["Run 20260613-181227-route_law_cold_first_active_label_route_sequence_wrong_next_v1"] --> B["Pass cases: 7"]
  A --> C["Fail cases: 0"]
  A --> D["Tool failures: 0"]
...
## Key Findings
- Most important pass: Cold label plus route sequence defeats wrong next id (PASS_CANDIDATE).
- Most important failure: Negative control wrong next only without route (HOLD_NEEDS_REVIEW).
...
## Artifact Paths
- Raw evidence: `study/raw/2026-06-13/route_law_cold_first_active_label_route_sequence_wrong_next_v1__20260613-181227-route_law_cold_first_active_label_route_sequence_wrong_next_v1.json`
- Review: `study/reviews/2026-06-13/route_law_cold_first_active_label_route_sequence_wrong_next_v1__20260613-181227-route_law_cold_first_active_label_route_sequence_wrong_next_v1.md`
