# Casework Review: route_law_contract_relaxation_matrix_v1

- **Run ID**: `20260613-153256-route_law_contract_relaxation_matrix_v1`
- **Imported At**: 2026-06-13T19:37:20.325Z
- **Raw Result JSON**: `study/raw/2026-06-13/route_law_contract_relaxation_matrix_v1__20260613-153256-route_law_contract_relaxation_matrix_v1.json`
- **Case Count**: 8

## Reflection Checklist
- [x] Mermaid-first review generated
- [x] Most important pass identified: Strict continue control preserves active chunk (PASS_CANDIDATE)
- [x] Most important failure identified: Late wrong-next negative control (FAIL_LOST_ROUTE)
...
```mermaid
flowchart TD
  A["Run 20260613-153256-route_law_contract_relaxation_matrix_v1"] --> B["Pass cases: 7"]
  A --> C["Fail cases: 1"]
  A --> D["Tool failures: 0"]
...
## Key Findings
- Most important pass: Strict continue control preserves active chunk (PASS_CANDIDATE).
- Most important failure: Late wrong-next negative control (FAIL_LOST_ROUTE).
...
## Artifact Paths
- Raw evidence: `study/raw/2026-06-13/route_law_contract_relaxation_matrix_v1__20260613-153256-route_law_contract_relaxation_matrix_v1.json`
- Review: `study/reviews/2026-06-13/route_law_contract_relaxation_matrix_v1__20260613-153256-route_law_contract_relaxation_matrix_v1.md`
