# Casework Review: route_law_explicit_active_carrier_floor_confirmation_v1

- **Run ID**: `20260613-190753-route_law_explicit_active_carrier_floor_confirmation_v1`
- **Imported At**: 2026-06-13T23:13:10.665Z
- **Raw Result JSON**: `study/raw/2026-06-13/route_law_explicit_active_carrier_floor_confirmation_v1__20260613-190753-route_law_explicit_active_carrier_floor_confirmation_v1.json`
- **Case Count**: 12

## Reflection Checklist
- [x] Mermaid-first review generated
- [x] Most important pass identified: Cold active_chunk_id only (PASS_CANDIDATE)
- [x] Most important failure identified: Next-only negative control (HOLD_NEEDS_REVIEW)
...
```mermaid
flowchart TD
  A["Run 20260613-190753-route_law_explicit_active_carrier_floor_confirmation_v1"] --> B["Pass cases: 11"]
  A --> C["Fail cases: 0"]
  A --> D["Tool failures: 0"]
...
- Most important failure: Next-only negative control (HOLD_NEEDS_REVIEW).
...
## Artifact Paths
- Raw evidence: `study/raw/2026-06-13/route_law_explicit_active_carrier_floor_confirmation_v1__20260613-190753-route_law_explicit_active_carrier_floor_confirmation_v1.json`
- Review: `study/reviews/2026-06-13/route_law_explicit_active_carrier_floor_confirmation_v1__20260613-190753-route_law_explicit_active_carrier_floor_confirmation_v1.md`
