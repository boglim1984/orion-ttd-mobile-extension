# Casework Review: route_law_field_floor_v2

- **Run ID**: `20260613-165714-route_law_field_floor_v2`
- **Imported At**: 2026-06-13T21:03:04.532Z
- **Raw Result JSON**: `study/raw/2026-06-13/route_law_field_floor_v2__20260613-165714-route_law_field_floor_v2.json`
- **Case Count**: 9

## Reflection Checklist
- [x] Mermaid-first review generated
- [x] Most important pass identified: Full baseline without exact response contract (PASS_CANDIDATE)
- [x] Most important failure identified: Sequence plus index only (HOLD_NEEDS_REVIEW)
...
```mermaid
flowchart TD
  A["Run 20260613-165714-route_law_field_floor_v2"] --> B["Pass cases: 5"]
  A --> C["Fail cases: 0"]
  A --> D["Tool failures: 0"]
...
## Key Findings
- Most important pass: Full baseline without exact response contract (PASS_CANDIDATE).
- Most important failure: Sequence plus index only (HOLD_NEEDS_REVIEW).
...
## Artifact Paths
- Raw evidence: `study/raw/2026-06-13/route_law_field_floor_v2__20260613-165714-route_law_field_floor_v2.json`
- Review: `study/reviews/2026-06-13/route_law_field_floor_v2__20260613-165714-route_law_field_floor_v2.md`
