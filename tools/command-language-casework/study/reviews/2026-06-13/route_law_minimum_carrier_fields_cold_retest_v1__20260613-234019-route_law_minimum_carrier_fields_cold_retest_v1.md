# Casework Review: route_law_minimum_carrier_fields_cold_retest_v1

- **Run ID**: `20260613-234019-route_law_minimum_carrier_fields_cold_retest_v1`
- **Imported At**: 2026-06-14T03:47:17.801Z
- **Raw Result JSON**: `study/raw/2026-06-13/route_law_minimum_carrier_fields_cold_retest_v1__20260613-234019-route_law_minimum_carrier_fields_cold_retest_v1.json`
- **Case Count**: 18

## Reflection Checklist
- [x] Mermaid-first review generated
- [x] Most important pass identified: Cold stripped carrier (PASS_CANDIDATE)
- [x] Most important failure identified: No route_id (FAIL_LOST_ROUTE)
...
```mermaid
flowchart TD
  A["Run 20260613-234019-route_law_minimum_carrier_fields_cold_retest_v1"] --> B["Pass cases: 13"]
  A --> C["Fail cases: 4"]
  A --> D["Tool failures: 0"]
...
## Key Findings
- Most important pass: Cold stripped carrier (PASS_CANDIDATE).
- Most important failure: No route_id (FAIL_LOST_ROUTE).
...
- Language: Route-law failure labels appeared in 4 case(s).
...
## Artifact Paths
- Raw evidence: `study/raw/2026-06-13/route_law_minimum_carrier_fields_cold_retest_v1__20260613-234019-route_law_minimum_carrier_fields_cold_retest_v1.json`
- Review: `study/reviews/2026-06-13/route_law_minimum_carrier_fields_cold_retest_v1__20260613-234019-route_law_minimum_carrier_fields_cold_retest_v1.md`
