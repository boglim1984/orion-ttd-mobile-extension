...
- **Run ID**: `20260613-211109-route_law_protocol_activation_frame_minimum_v1`
- **Imported At**: 2026-06-14T01:17:51.890Z
- **Raw Result JSON**: `study/raw/2026-06-13/route_law_protocol_activation_frame_minimum_v1__20260613-211109-route_law_protocol_activation_frame_minimum_v1.json`
- **Case Count**: 18

## Reflection Checklist
- [x] Mermaid-first review generated
- [x] Most important pass identified: Full frame route_sequence baseline (PASS_CANDIDATE)
- [x] Most important failure identified: Route-id-only trap (FAIL_LOST_ROUTE)
...
```mermaid
flowchart TD
  A["Run 20260613-211109-route_law_protocol_activation_frame_minimum_v1"] --> B["Pass cases: 14"]
  A --> C["Fail cases: 2"]
  A --> D["Tool failures: 0"]
...
## Key Findings
- Most important pass: Full frame route_sequence baseline (PASS_CANDIDATE).
- Most important failure: Route-id-only trap (FAIL_LOST_ROUTE).
...
## Artifact Paths
- Raw evidence: `study/raw/2026-06-13/route_law_protocol_activation_frame_minimum_v1__20260613-211109-route_law_protocol_activation_frame_minimum_v1.json`
- Review: `study/reviews/2026-06-13/route_law_protocol_activation_frame_minimum_v1__20260613-211109-route_law_protocol_activation_frame_minimum_v1.md`
