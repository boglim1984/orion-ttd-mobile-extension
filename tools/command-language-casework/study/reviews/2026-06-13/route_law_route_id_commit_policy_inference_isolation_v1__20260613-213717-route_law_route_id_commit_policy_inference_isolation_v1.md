# Casework Review: route_law_route_id_commit_policy_inference_isolation_v1

- **Run ID**: `20260613-213717-route_law_route_id_commit_policy_inference_isolation_v1`
- **Imported At**: 2026-06-14T01:44:52.549Z
- **Raw Result JSON**: `study/raw/2026-06-13/route_law_route_id_commit_policy_inference_isolation_v1__20260613-213717-route_law_route_id_commit_policy_inference_isolation_v1.json`
- **Case Count**: 18

## Reflection Checklist
- [x] Mermaid-first review generated
- [x] Most important pass identified: Cold active-only baseline (PASS_CANDIDATE)
- [x] Most important failure identified: No-active route_id sentinel (HOLD_NEEDS_REVIEW)
...
```mermaid
flowchart TD
  A["Run 20260613-213717-route_law_route_id_commit_policy_inference_isolation_v1"] --> B["Pass cases: 14"]
  A --> C["Fail cases: 0"]
  A --> D["Tool failures: 0"]
...
## Key Findings
- Most important pass: Cold active-only baseline (PASS_CANDIDATE).
- Most important failure: No-active route_id sentinel (HOLD_NEEDS_REVIEW).
...
## Artifact Paths
- Raw evidence: `study/raw/2026-06-13/route_law_route_id_commit_policy_inference_isolation_v1__20260613-213717-route_law_route_id_commit_policy_inference_isolation_v1.json`
- Review: `study/reviews/2026-06-13/route_law_route_id_commit_policy_inference_isolation_v1__20260613-213717-route_law_route_id_commit_policy_inference_isolation_v1.md`
