...
- **Run ID**: `20260613-001420-scorer_keyword_extraction_v2`
- **Imported At**: 2026-06-13T04:14:36.910Z
- **Raw Result JSON**: `study/raw/2026-06-13/scorer_keyword_extraction_v2__20260613-001420-scorer_keyword_extraction_v2.json`
- **Case Count**: 8

## Reflection Checklist
- [x] Mermaid-first review generated
- [x] Most important pass identified: Human-readable chunk label in final transition line (PASS_CANDIDATE)
- [x] Most important failure identified: Exact chunk id in final transition line (FAIL_LOST_ROUTE)
...
```mermaid
flowchart TD
  A["Run 20260613-001420-scorer_keyword_extraction_v2"] --> B["Pass cases: 3"]
  A --> C["Fail cases: 5"]
  A --> D["Tool failures: 0"]
...
## Key Findings
- Most important pass: Human-readable chunk label in final transition line (PASS_CANDIDATE).
- Most important failure: Exact chunk id in final transition line (FAIL_LOST_ROUTE).
...
## Artifact Paths
- Raw evidence: `study/raw/2026-06-13/scorer_keyword_extraction_v2__20260613-001420-scorer_keyword_extraction_v2.json`
- Review: `study/reviews/2026-06-13/scorer_keyword_extraction_v2__20260613-001420-scorer_keyword_extraction_v2.md`
