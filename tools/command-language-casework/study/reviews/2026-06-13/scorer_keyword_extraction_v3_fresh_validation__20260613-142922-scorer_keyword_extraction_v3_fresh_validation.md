# Casework Review: scorer_keyword_extraction_v3_fresh_validation

- **Run ID**: `20260613-142922-scorer_keyword_extraction_v3_fresh_validation`
- **Imported At**: 2026-06-13T18:31:00.692Z
- **Raw Result JSON**: `study/raw/2026-06-13/scorer_keyword_extraction_v3_fresh_validation__20260613-142922-scorer_keyword_extraction_v3_fresh_validation.json`
- **Case Count**: 2

## Reflection Checklist
- [x] Mermaid-first review generated
- [x] Most important pass identified: Fresh legal move_on to collect_dishes ID only (PASS_CANDIDATE)
- [x] Most important failure identified: Fresh wrong-next stack_papers negative control (FAIL_LOST_ROUTE)
...
```mermaid
flowchart TD
  A["Run 20260613-142922-scorer_keyword_extraction_v3_fresh_validation"] --> B["Pass cases: 1"]
  A --> C["Fail cases: 1"]
  A --> D["Tool failures: 0"]
...
## Key Findings
- Most important pass: Fresh legal move_on to collect_dishes ID only (PASS_CANDIDATE).
- Most important failure: Fresh wrong-next stack_papers negative control (FAIL_LOST_ROUTE).
...
## Artifact Paths
- Raw evidence: `study/raw/2026-06-13/scorer_keyword_extraction_v3_fresh_validation__20260613-142922-scorer_keyword_extraction_v3_fresh_validation.json`
- Review: `study/reviews/2026-06-13/scorer_keyword_extraction_v3_fresh_validation__20260613-142922-scorer_keyword_extraction_v3_fresh_validation.md`
