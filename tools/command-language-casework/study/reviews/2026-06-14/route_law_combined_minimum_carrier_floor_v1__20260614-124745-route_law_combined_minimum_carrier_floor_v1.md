# Casework Review: route_law_combined_minimum_carrier_floor_v1

- **Run ID**: `20260614-124745-route_law_combined_minimum_carrier_floor_v1`
- **Imported At**: 2026-06-14T17:17:09.264Z
- **Raw Result JSON**: `study/raw/2026-06-14/route_law_combined_minimum_carrier_floor_v1__20260614-124745-route_law_combined_minimum_carrier_floor_v1.json`
- **Case Count**: 18

## Reflection Checklist
- [x] Mermaid-first review generated
- [x] Most important pass identified: Cold suspected floor: marker plus route_id plus active_chunk_id only (PASS_CANDIDATE)
- [x] Most important failure identified: Route id only (HOLD_NEEDS_REVIEW)
...
```mermaid
flowchart TD
  A["Run 20260614-124745-route_law_combined_minimum_carrier_floor_v1"] --> B["Pass cases: 17"]
  A --> C["Fail cases: 0"]
  A --> D["Tool failures: 0"]
...
## Key Findings
- Most important pass: Cold suspected floor: marker plus route_id plus active_chunk_id only (PASS_CANDIDATE).
- Most important failure: Route id only (HOLD_NEEDS_REVIEW).
...
## Artifact Paths
- Raw evidence: `study/raw/2026-06-14/route_law_combined_minimum_carrier_floor_v1__20260614-124745-route_law_combined_minimum_carrier_floor_v1.json`
- Review: `study/reviews/2026-06-14/route_law_combined_minimum_carrier_floor_v1__20260614-124745-route_law_combined_minimum_carrier_floor_v1.md`
