# Casework Review: route_law_fresh_context_minimum_carrier_route_active_bare_cold_probe_8case_v1

- **Run ID**: `20260614-142943-route_law_fresh_context_minimum_carrier_route_active_bare_cold_probe_8case_v1`
- **Imported At**: 2026-06-14T18:34:23.180Z
- **Raw Result JSON**: `study/raw/2026-06-14/route_law_fresh_context_minimum_carrier_route_active_bare_cold_probe_8case_v1__20260614-142943-route_law_fresh_context_minimum_carrier_route_active_bare_cold_probe_8case_v1.json`
- **Case Count**: 8

## Reflection Checklist
- [x] Mermaid-first review generated
- [x] Most important pass identified: Bare route_id plus active_chunk_id cold carrier (PASS_CANDIDATE)
- [x] Most important failure identified: Active chunk id only negative control (FAIL_LOST_ROUTE)
...
```mermaid
flowchart TD
  A["Run 20260614-142943-route_law_fresh_context_minimum_carrier_route_active_bare_cold_probe_8case_v1"] --> B["Pass cases: 5"]
  A --> C["Fail cases: 1"]
  A --> D["Tool failures: 0"]
...
## Key Findings
- Most important pass: Bare route_id plus active_chunk_id cold carrier (PASS_CANDIDATE).
- Most important failure: Active chunk id only negative control (FAIL_LOST_ROUTE).
...
## Artifact Paths
- Raw evidence: `study/raw/2026-06-14/route_law_fresh_context_minimum_carrier_route_active_bare_cold_probe_8case_v1__20260614-142943-route_law_fresh_context_minimum_carrier_route_active_bare_cold_probe_8case_v1.json`
- Review: `study/reviews/2026-06-14/route_law_fresh_context_minimum_carrier_route_active_bare_cold_probe_8case_v1__20260614-142943-route_law_fresh_context_minimum_carrier_route_active_bare_cold_probe_8case_v1.md`
