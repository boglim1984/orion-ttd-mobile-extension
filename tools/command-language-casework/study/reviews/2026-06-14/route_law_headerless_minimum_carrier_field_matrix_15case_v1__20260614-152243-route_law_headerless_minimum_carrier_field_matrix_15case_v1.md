# Casework Review: route_law_headerless_minimum_carrier_field_matrix_15case_v1

- **Run ID**: `20260614-152243-route_law_headerless_minimum_carrier_field_matrix_15case_v1`
- **Imported At**: 2026-06-14T19:28:45.444Z
- **Raw Result JSON**: `study/raw/2026-06-14/route_law_headerless_minimum_carrier_field_matrix_15case_v1__20260614-152243-route_law_headerless_minimum_carrier_field_matrix_15case_v1.json`
- **Case Count**: 15

## Reflection Checklist
- [x] Mermaid-first review generated
- [x] Most important pass identified: Smallest plausible carrier: route_id + active_chunk_id + commit_policy (PASS_CANDIDATE)
- [x] Most important failure identified: Negative control: label-only (FAIL_LOST_ROUTE)
...
```mermaid
flowchart TD
  A["Run 20260614-152243-route_law_headerless_minimum_carrier_field_matrix_15case_v1"] --> B["Pass cases: 11"]
  A --> C["Fail cases: 3"]
  A --> D["Tool failures: 0"]
...
## Key Findings
- Most important pass: Smallest plausible carrier: route_id + active_chunk_id + commit_policy (PASS_CANDIDATE).
- Most important failure: Negative control: label-only (FAIL_LOST_ROUTE).
...
## Artifact Paths
- Raw evidence: `study/raw/2026-06-14/route_law_headerless_minimum_carrier_field_matrix_15case_v1__20260614-152243-route_law_headerless_minimum_carrier_field_matrix_15case_v1.json`
- Review: `study/reviews/2026-06-14/route_law_headerless_minimum_carrier_field_matrix_15case_v1__20260614-152243-route_law_headerless_minimum_carrier_field_matrix_15case_v1.md`
