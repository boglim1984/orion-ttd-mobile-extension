# Casework Review: route_law_protocol_activation_frame_ablation_route_active_carrier_8case_v1

- **Run ID**: `20260614-144052-route_law_protocol_activation_frame_ablation_route_active_carrier_8case_v1`
- **Imported At**: 2026-06-14T18:45:14.882Z
- **Raw Result JSON**: `study/raw/2026-06-14/route_law_protocol_activation_frame_ablation_route_active_carrier_8case_v1__20260614-144052-route_law_protocol_activation_frame_ablation_route_active_carrier_8case_v1.json`
- **Case Count**: 8

## Reflection Checklist
- [x] Mermaid-first review generated
- [x] Most important pass identified: Known-good route_id plus active_chunk_id carrier baseline (PASS_CANDIDATE)
- [x] Most important failure identified: Missing active_chunk_id negative control (HOLD_NEEDS_REVIEW)
...
```mermaid
flowchart TD
  A["Run 20260614-144052-route_law_protocol_activation_frame_ablation_route_active_carrier_8case_v1"] --> B["Pass cases: 7"]
  A --> C["Fail cases: 0"]
  A --> D["Tool failures: 0"]
...
## Key Findings
- Most important pass: Known-good route_id plus active_chunk_id carrier baseline (PASS_CANDIDATE).
- Most important failure: Missing active_chunk_id negative control (HOLD_NEEDS_REVIEW).
...
## Artifact Paths
- Raw evidence: `study/raw/2026-06-14/route_law_protocol_activation_frame_ablation_route_active_carrier_8case_v1__20260614-144052-route_law_protocol_activation_frame_ablation_route_active_carrier_8case_v1.json`
- Review: `study/reviews/2026-06-14/route_law_protocol_activation_frame_ablation_route_active_carrier_8case_v1__20260614-144052-route_law_protocol_activation_frame_ablation_route_active_carrier_8case_v1.md`
