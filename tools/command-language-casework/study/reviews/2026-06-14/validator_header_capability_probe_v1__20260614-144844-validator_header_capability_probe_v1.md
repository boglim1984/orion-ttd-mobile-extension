# Casework Review: validator_header_capability_probe_v1

- **Run ID**: `20260614-144844-validator_header_capability_probe_v1`
- **Imported At**: 2026-06-14T18:54:25.584Z
- **Raw Result JSON**: `study/raw/2026-06-14/validator_header_capability_probe_v1__20260614-144844-validator_header_capability_probe_v1.json`
- **Case Count**: 2

## Reflection Checklist
- [x] Mermaid-first review generated
- [x] Most important pass identified: Known-good header packet validates (PASS_CANDIDATE)
...
```mermaid
flowchart TD
  A["Run 20260614-144844-validator_header_capability_probe_v1"] --> B["Pass cases: 2"]
  A --> C["Fail cases: 0"]
  A --> D["Tool failures: 0"]
...
## Key Findings
- Most important pass: Known-good header packet validates (PASS_CANDIDATE).
...
## Artifact Paths
- Raw evidence: `study/raw/2026-06-14/validator_header_capability_probe_v1__20260614-144844-validator_header_capability_probe_v1.json`
- Review: `study/reviews/2026-06-14/validator_header_capability_probe_v1__20260614-144844-validator_header_capability_probe_v1.md`
